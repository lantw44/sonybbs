...
/* lantw44: 從 ch_printmsg() 搬出來的函式宣告 */
...
{
  "  ", "●", 		/* Empty, Cover */
  "\033[1;31m帥\033[m", "\033[1;31m仕\033[m", "\033[1;31m相\033[m",
  "\033[1;31m硨\033[m", "\033[1;31m傌\033[m", "\033[1;31m炮\033[m", "\033[1;31m兵\033[m",
  "\033[1;32m將\033[m", "\033[1;32m士\033[m", "\033[1;32m象\033[m",
  "\033[1;32m車\033[m", "\033[1;32m馬\033[m", "\033[1;32m包\033[m", "\033[1;32m卒\033[m"
};
 ...
 */
  ...
  case 2:			/* for select */
    sprintf(buf, "\033[1;33m◆您選取了 %s\033[1;33m(%d, %c)\033[m",
  ...
  int row;
{
  ...
  move(row + 1, 0);
  if (row == 9 && Choose) {
    strcpy(buf, "  Ｏ  １  ２  ３  ４  ５  ６  ７     ");
    strcat(buf, dstr[row]);
    return buf;
  }  
  else if (row > 8 && Choose) {	/* 暗棋的 row 最多到 8 */
...
ch_init()
{
  ...
  strcpy(dstr[2],"☆我方所吃之子");
  strcpy(dstr[5],"★對方所吃之子");
  strcpy(dstr[8],"====================================");
...
ch_recv()
{
  ...
  case 'D':
    ...
    Totalch++;
    mapTurn = myTurn;
    sprintf(msg, "\033[1;32m△對方翻開 %s\033[1;32m(%d, %c)\033[m", ch_icon[ch], col, row + 'A');
    ch_draw();
    ch_printmsg(1, msg);
    break;
  ...
  case 'E':
    ...
    mapTurn = myTurn;
    sprintf(msg, "\033[1;32m▽對方移動 %s\033[1;32m(%d, %c) 吃 %s\033[1;32m(%d, %c)\033[m",
  ...
  case 'M':
    ...
    Board[row2][col2] = ch;
    mapTurn = myTurn;
    sprintf(msg, "\033[1;37m▽對方移動 %s\033[1;37m(%d, %c) 至 (%d, %c)\033[m",
...
ch_Mv0()			/* for 軍棋 */
{
  ...
  if (way == 1)
  {
    ...
    if (!do_send(buf))
      return DISCONNECT;
    sprintf(buf, "\033[1;36m▼我方移動 %s\033[1;36m(%d, %c) 至 (%d, %c)\033[m",
  ...
  else if (way == 2)
  {
    ...
    if (!do_send(buf))
      return DISCONNECT;
    sprintf(buf, "\033[1;32m▼我方移動 %s\033[1;32m(%d, %c) 吃 %s\033[1;32m(%d, %c)\033[m",
...
chEnter()
{
  ...
  if (ch == Cover)	/* 暗棋翻子 */
  {
    ...
    mapTurn = yourTurn;
    Focus = Empty;
    sprintf(buf, "\033[1;32m▲我方翻開 %s\033[1;32m(%d, %c)\033[m",
