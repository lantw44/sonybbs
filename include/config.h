...
#define BBSNAME		"索尼小站"		/* 中文站名 */
#define BBSNAME2	"SonyBBS"		/* 英文站名 */
#define SYSOPNICK	"工友北北"		/* sysop 的暱稱 */
#define TAG_VALID       "["BBSNAME2"]To"	/* 身分認證函 token */

#define MYIPADDR	"210.70.137.212"	/* IP address */
#define MYHOSTNAME	"sony.tfcis.org"	/* 網路地址 FQDN */
...
#define BAKPATH		"/home/bbsbak"		/* 備份檔的路徑 */
...
#undef	HAVE_UNANONYMOUS_BOARD	/* itoc.020602: 反匿名板，必須有開 BN_UNANONYMOUS */
#endif

#define	SHOW_USER_IN_TEXT       /* 在文件中 Ctrl+Q 可顯示 User 的名字 */

#define	ANTI_PHONETIC		/* itoc.030503: 禁用注音文 */
...
#ifdef HAVE_COSIGN
#define NBRD_NUM_BRD	10		/* 開板需要連署人數 */
...
#define CROSSPOST_DENY_DAY	1	/* cross post 停權時間(天) */
#endif
