...
#define NECKER_CLASS	"[←]主選單 [→]閱\讀 [↑↓]選擇 [W]查詢 [y]載入 [/?]搜尋 [s]看板 [h]說明\n" \
...
#define NECKER_XPOST	"\n" \
			COLOR3 "  編號    日 期 作  者       文  章  標  題%*s                     ㄅ:%s  評:%s  \033[m"

#define NECKER_MBOX	"[←]離開 [→,r]讀信 [d]刪除 [R,y](群組)回信 [s]寄信 [x]轉錄 [X]轉達 [h]說明\n" \
			COLOR3 "  編號   日 期 作  者       信  件  標  題%*s                                    \033[m"

#define NECKER_POST	"[←]離開 [→]閱\讀 [^P]發表 [b]進板畫面 [d]刪除 [I,W]查詢 [TAB]精華區 [h]說明\n" \
			COLOR3 "  編號    日 期 作  者       文  章  標  題%*s          ㄅ:%s  評:%s  人氣:%-4d  \033[m"
...
#define FOOTER_VEDIT	\
COLOR1 " %s " COLOR2 " (^Z)說明(^W)符號(^L)重繪(^X)檔案(^G)全型║%s│%s║%5d:%3d    \033[m"
...
/* 新站簽 by  hppy.bbs@sony.tfcis.org  */
#define	EDIT_BANNER	"\n--\n" \
"\033[1m               \033[42m┼\033[40m─╮                  ╭───────╮\033[m\n" \
"\033[1m               │  │\033[1m功033[mx俞033[1mn一么033[m丑D珮033[1m薔坐\033[mp珮033[1m稞033[m∣\033[1msony.TFcis.org│  │\033[m\n" \
"\033[1m                   ╰─────────╯              ╰─\033[42m┼\033[m\n" \
"\033[1m               by %s from \033[m \033[1m%s (%s)\033[m\n\n"
	
#define MODIFY_BANNER	"▲ \033[1;30m%s \033[;33m改\033[m@\033[m%s\033[m\n"
...
#define ICON_UNREAD_BRD		"\033[0;32mˇ"		/* 未讀看板 */
